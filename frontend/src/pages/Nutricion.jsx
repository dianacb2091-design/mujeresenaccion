    ...
    return (
        ...
        >
            <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg p-8">
                ...
                >
                    Videos, PDFs y consejos sobre alimentación saludable para cuidadoras.
                </p>
                ...
                {/* Pestañas */}
                <div className="flex gap-8 mt-8 border-b border-pink-100 pb-3 text-lg">
                ...
                {activeTab === "videos" && (
                    ...
                    <div className="mt-8 space-y-4">
                        ...
                        <div className="bg-white border border-pink-100 rounded-2xl p-5 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                            <h3 style={{ color: "#d63384" }} className="text-lg font-bold">
                                🥗 Video 1
                            </h3>

                            <p style={{ color: "#664455" }}>
                                Introducción a una alimentación saludable.
                            </p>

                            <button
                                className="mt-4 px-5 py-2 rounded-xl text-white font-semibold shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300"
                        ...
                        <div className="bg-white border border-pink-100 rounded-2xl p-5 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                            ...
                            <button
                                className="mt-4 px-5 py-2 rounded-xl text-white font-semibold hover:opacity-90 transition-all duration-300"
                                style={{ backgroundColor: "#d63384" }}
                            >
                                ▶ Ver video
                            </button>
                    ...
                    <div className="mt-8 space-y-4">
                        ...
                        <div className="bg-white border border-pink-100 rounded-2xl p-5 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                            ...
                            <p className="mt-2" style={{ color: "#664455" }}>
                                Aprende los principios básicos de una alimentación balanceada.
                            </p>

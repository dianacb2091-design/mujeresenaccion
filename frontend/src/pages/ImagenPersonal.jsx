        ...
        <div className="min-h-screen p-8" style={{ backgroundColor: "#fdf5f0" }}>
            <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg p-8">
                ...
                <p className="mt-3" style={{ color: "#664455", fontSize: "17px", lineHeight: "1.8" }}>
                    Aprende hábitos de higiene, presentación personal y autoestima para fortalecer tu imagen.
                </p>

                <div className="mt-8">
                    <div className="flex justify-between text-sm mb-2">
                        <span style={{ color: "#664455" }}>Progreso del módulo</span>
                        <span style={{ color: "#d63384" }}>0 de 3 videos</span>
                    </div>
                ...
                {activeTab === "videos" && (
                    ...
                    <div className="mt-8 space-y-4">
                        ...
                        <div className="bg-white border border-pink-100 rounded-2xl p-5 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                            ...
                            <p style={{ color: "#664455" }}>Presentación e imagen personal.</p>
                        ...
                        <div className="bg-white border border-pink-100 rounded-2xl p-5 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                            ...
                            <p style={{ color: "#664455" }}>Vestimenta adecuada para el trabajo.</p>
                            <button className="mt-3 px-4 py-2 rounded-lg text-white" style={{ backgroundColor: "#d63384" }}>
                                Ver video
                            </button>
                        </div>
                        ...
                        <div className="bg-white border border-pink-100 rounded-2xl p-5 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                            <h3 style={{ color: "#d63384" }}>✨ Video 3</h3>
                            <p style={{ color: "#664455" }}>Cuidado de la imagen y autoestima.</p>
                            <button className="mt-3 px-4 py-2 rounded-lg text-white" style={{ backgroundColor: "#d63384" }}>
                                Ver video
                            </button>
                        </div>
                    ...
                    <div className="mt-8 space-y-4">
                        ...
                        <div className="bg-white border border-pink-100 rounded-2xl p-5 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                            ...
                            <h3 className="text-lg font-bold" style={{ color: "#d63384" }}>
                                📄 Guía de Imagen Personal
                            </h3>

                            <p className="mt-2" style={{ color: "#664455" }}>
                                Aprende hábitos de higiene, presentación personal y autoestima.
                            </p>
